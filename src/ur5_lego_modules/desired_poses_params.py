...
desired_poses.append(DesiredPose2D( label = "X1-Y2-Z2-TWINFILLET", x = -0.1, y = 0.2, theta = PI ))
desired_poses.append(DesiredPose2D( label = "X1-Y4-Z2", x = -0.1, y = 0.35, theta = PI/6 ))
