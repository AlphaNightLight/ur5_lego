...
actual_poses.append(ActualPose2D( label = "X1-Y2-Z2-TWINFILLET", x = 0.3, y = 0.15, theta = PI ))
actual_poses.append(ActualPose2D( label = "X1-Y4-Z2", x = 0.4, y = 0.4, theta = PI/6 ))
